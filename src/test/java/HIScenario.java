...
public class HIScenario {
  ...
  public void testHIScenario() throws Exception {
    ...
    driver.findElement(By.xpath("//li[@id='manageASPAndPriority']//a[@class='dropdown-toggle']")).click(); //driver.findElement(By.linkText("ASPs & Configuration")).click(); 
    ...
    new Select(driver.findElement(By.id("destBuildingNameTemp0"))).selectByVisibleText("Building 1");
    Thread.sleep(3000);
    ...
    new Select(driver.findElement(By.id("destLobbyNameTemp0"))).selectByVisibleText("Lobby 1");
    Thread.sleep(3000);
    ...
    new Select(driver.findElement(By.id("destFloorNumber0"))).selectByVisibleText("Floor 1");
    Thread.sleep(3000);
    ...
    new Select(driver.findElement(By.id("destUnitNumberTemp0"))).selectByVisibleText("Unit 1");
    Thread.sleep(3000);
